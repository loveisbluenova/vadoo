...
$website_ffcountmmm_query = "SELECT COUNT(*) FROM  chatmessages WHERE user_id=$session_user_id OR receiver=$session_user_id";
foreach ($connread->query($website_ffcountmmm_query) as $row) {
		 $count_famb=$row['COUNT(*)'];
		 if($count_famb==0){
       header("Location: index.php?messagenot=true");
		 }
		 }			 
...
if (strpos($f_buzzyuser_image,'facebook') !== false) {
    ...
    $all_msgquery = "SELECT * FROM chatmessages WHERE (user_id=$session_user_id AND receiver=$f_buzzyuser_id) OR (user_id=$f_buzzyuser_id AND receiver=$session_user_id) ORDER by id DESC LIMIT 1";	 
	foreach ($connread->query($all_msgquery) as $row) {
	$last_message=$row['message'];	
include 'HTML/message-class.html';
$last_message = str_replace($patterns, $replacements, $last_message);
$buzzyuser_chat_difference=time()-$row['time'];
	...
	?>
<div style="float:none!important; margin-bottom:20px; margin-left:20px; margin-right:20px;">
<a data-toggle="tooltip" data-placement="bottom" title="<?php echo $chat_with;?> <?php echo $f_buzzyuser_first_name;?>" href="<?php echo $link_prefix;?>mobile-talk.php?user-id=<?php echo $f_buzzyuser_id;?>">
<img src="<?php echo $final_image_prefix;?><?php echo $f_buzzyuser_image;?>"
style="margin-right:12px!important; border-radius:12px 12px 12px 12px;
-moz-border-radius:12px 12px 12px 12px;
-webkit-border-radius:12px 12px 12px 12px;
float:left!important; width:64px!important; height:64px!important;">
<span style="font-weight:700;"><?php echo $f_buzzyuser_first_name;?> <?php echo $f_buzzyuser_last_name;?> 
<span style="font-weight:400; font-size:11px; float:right!important;"><i class="fa fa-clock-o" aria-hidden="true"></i> <?php echo $final_buzzyuser_chat_difference;?>
<?php echo $date_measure;?> <?php echo $ago;?></span>
</span>
<br>
<span style="font-weight:400; color:#333!important;"><?php echo $last_message;?></span>
</a>
</div>
