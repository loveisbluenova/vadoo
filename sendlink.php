...
$link_message='<a href="'.$message.'"  >'.$message.'</a>';
$receiver=$_POST['receiver'];
        $add_msg_query = "INSERT INTO  messages(message,time,user_id,receiver,storage_a,storage_b,status)
		 	  VALUES(:message,:time,:user_id,:receiver,:storage_a,:storage_b,0)";
        // prepare the statement
        $stmt = $connwrite->prepare($add_msg_query);
        // bind the parameters and execute the statement
        $stmt->bindParam(':message', $link_message, PDO::PARAM_STR);
