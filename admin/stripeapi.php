...
include 'PHP/editstripeapicode.php';
$current1 = 'current';
$current2 = '';
$current3 = '';
$current4='';
    ...
    <div class="content">
        <div id="sample">
            <div class="content-empty">
                ...
                <input type="text" class="form-control" name="buzzy_stripekey" required value="<?php echo $buzzy_stripekey;?>" data-toggle="tooltip" data-placement="right" title="Type your Stripe key here">	   
				<h3>Stripe 100 credits price (USD)</h3>
                <input type="text" class="form-control" name="buzzy_stripeprice" required value="<?php echo $buzzy_stripeprice;?>" data-toggle="tooltip" data-placement="right" title="Type your Stripe price here">	 			
				<div class="clearfix"></div>					
				<?php }	?>				
				<br>
					<button type="submit" name="update_stripe_options" class="btn btn-primary">Submit Stripe api options</button>
                </form>
				<?php }	?>	
				<?php
