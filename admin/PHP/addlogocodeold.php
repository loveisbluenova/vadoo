...
$update_logo_image_query = "UPDATE  buzzysiteoptions
SET buzzysitelogo=:buzzysitelogo WHERE buzzysiteoptions_id=1";
        $stmt = $connwrite->prepare($update_logo_image_query);
        // bind the parameters and execute the statement
        // execute and get number of affected rows
        $stmt->bindParam(':buzzysitelogo', $image, PDO::PARAM_STR);				
        $stmt->execute();
        $OK = $stmt->rowCount();
}
