    ...
    <div class="content">
        <div id="sample">
            <div class="content-empty">
                ...
                <input type="text" name="buzzyuser_interest_category" class="form-control" required placeholder="Interest category" data-toggle="tooltip" data-placement="right" title="Add your interest category here">
 				<h3>User interest category icon</h3>
			    <input type="text" name="buzzyuser_interest_category_icon" class="form-control" required placeholder="Interest category icon (ex: )" data-toggle="tooltip" data-placement="right" title="Add your interest category icon here">	
