...
include 'PHP/editgooglecode.php';
$current1 = '';
$current2 = '';
$current3 = '';
$current4='';
...
<div class="fifth-sixth-column">
    ...
    <div class="content">
        <div id="sample">
            <div class="content-empty">
                <h1>
                   Add your Google analytics code (Tracking Id)
                </h1>
			    <?php
                ...
                <input type="text" class="form-control" name="buzzybuzzga" required value="<?php echo htmlspecialchars($buzzybuzzga, ENT_QUOTES); ?>" data-toggle="tooltip" data-placement="right" title="Add your tracking id here...">	 
				   <div class="clearfix"></div>					
					<button type="submit" name="update_ga" class="btn btn-primary">Submit your tracking ID here</button>
                </form>
				<?php } ?>
                <br>
            </div>
