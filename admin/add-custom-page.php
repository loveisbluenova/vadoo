...
include 'PHP/addcustompagecode.php';
	$current1='';
	$current2='';
	$current3='';
	$current4='';
    ...
    <div class="content">
        <div id="sample">
            <div class="content-empty">
                ...
                <input type="text"   name="buzzycustompage_title" required class="form-control" > 
 				<h3>Custom page url</h3>
                <input type="text"   name="buzzycustompage_url" required class="form-control" >               	
				...
				<br>
                 <button type="submit" name="add_custom_page" class="btn btn-primary">Submit page</button>
                </form>
                <br>
            </div>
        </div>
