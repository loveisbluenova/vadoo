    ...
    <div class="content">
        <div id="sample">
            <div class="content-empty">
				...
				<h3>Gift title</h3>
                <input type="text" name="buzzygift_title" class="form-control" required placeholder="Gift title" data-toggle="tooltip" data-placement="right" title="Add your Gift title here">
 				<h3>Gift price (credits)</h3>
                <input type="number" name="buzzygift_price" min="0" max="10000" class="form-control" required placeholder="0" data-toggle="tooltip" data-placement="right" title="Add your Gift price here">                   
                    <button type="submit" name="add_gift" class="btn btn-primary">Submit gift</button>
                </form>
                <br>
            </div>
        </div>
