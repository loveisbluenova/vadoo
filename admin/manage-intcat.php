    ...
    <div class="content">
        <div id="sample">
			...
			?>
			    ...
			    <input type="text" name="buzzyuser_interest_category_icon" class="form-control" required value="<?php echo $buzzyuser_interest_category_icon;?>" data-toggle="tooltip" data-placement="right" title="Add your interest category icon here">	
                <button type="submit" name="edit_interest_category" class="btn btn-primary">Submit interest category</button>
                </form>
                <br>
            </div>
        </div>
