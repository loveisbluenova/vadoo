...
(function($) {
	...
	$("#text-messages-request").on("focus", "textarea.type-a-message-box", function() { 
		...
		$('div.message-btn-targeta').html('<a href="#" id="'+ID+'" style="float:right!important; margin-top:10px; margin-right:10px;" class="btn btn-primary btn-sm send-message" ><i class="glyphicon glyphicon-send"></i> '+$.sendButton+'</a>');
	...
	$('body').on('click', '#emoticons', function() {
		...
		$('.modal-body').html(
			'<img class="emoticons" style="margin-right:10px!important; width:56px!important; height:56px!important; margin-bottom:20px!important;" src="http://www.allsmileys.com/files/smiley-central-animals/5132.gif" id="an1" data-value=":an1:">' +
			'<img class="emoticons" style="margin-right:10px!important; width:56px!important; height:56px!important;  margin-bottom:20px!important;" src="http://www.allsmileys.com/files/smiley-central-animals/5123.gif" id="an2" data-value=":an2:">' +
			'<img class="emoticons" style="margin-right:10px!important; width:56px!important; height:56px!important;  margin-bottom:20px!important;" src="http://www.allsmileys.com/files/smiley-central-animals/5131.gif" id="an3" data-value=":an3:">' +
			'<img class="emoticons" style="margin-right:10px!important; width:56px!important; height:56px!important;  margin-bottom:20px!important;" src="http://www.allsmileys.com/files/smiley-central-animals/5128.gif" id="an4" data-value=":an4:">'	 +	
			'<img class="emoticons" style="margin-right:10px!important; width:56px!important; height:56px!important;  margin-bottom:20px!important;" src="http://www.allsmileys.com/files/smiley-central-animals/5136.gif" id="an5" data-value=":an5:">'	+	
			'<img class="emoticons" style="margin-right:10px!important; width:56px!important; height:56px!important;   margin-bottom:20px!important;" src="http://www.allsmileys.com/files/smiley-central-animals/5122.gif" id="an6" data-value=":an6:">'	+		
			'<img class="emoticons" style="margin-right:10px!important; width:56px!important; height:56px!important;  margin-bottom:20px!important;" src="http://www.allsmileys.com/files/smiley-central-animals/5133.gif" id="an7" data-value=":an7:">'	+		
			'<img class="emoticons" style="margin-right:10px!important; width:56px!important; height:56px!important;    margin-bottom:20px!important;" src="http://www.allsmileys.com/files/smiley-central-animals/5127.gif" id="an8" data-value=":an8:">'	+	
			'<img class="emoticons" style="margin-right:10px!important; width:56px!important; height:56px!important;    margin-bottom:20px!important;" src="http://www.allsmileys.com/files/smiley-central-animals/5121.gif" id="an9" data-value=":an9:">'	+	
			'<img class="emoticons" style="margin-right:10px!important; width:56px!important; height:56px!important;  margin-bottom:20px!important;" src="http://www.allsmileys.com/files/smiley-central-animals/5124.gif" id="an10" data-value=":an10:">'	 +
		'<img class="emoticons" style="margin-right:10px!important; width:56px!important; height:56px!important;  margin-bottom:20px!important;" src="http://www.allsmileys.com/files/smiley-central-animals/5126.gif" id="an10" data-value=":an11:">'	+						
		'<img class="emoticons" style="margin-right:10px!important; width:56px!important; height:56px!important;  margin-bottom:20px!important;" src="http://www.allsmileys.com/files/smiley-central-animals/5120.gif" id="an10" data-value=":an12:">'
		);
		$('#generalModal').modal('show');
		$(".emoticons").on('click', function()
		{
	...
	$('body').on('click', '#love', function() {
		...
		$('.modal-body').html(
			'<div class="clearfix"></div><div style="margin-right:10px!important; float:left!important; width:56px!important; height:56px!important;"><img class="emoticons" style=" width:48px!important;" src="http://www.myemoticons.com/images/love/couples/couples.gif" id="an1" data-value=":love1:"></div>' +
            '<div style="margin-right:10px!important; float:left!important; width:56px!important; height:56px!important;"><img class="emoticons" style=" width:48px!important;" src="http://www.myemoticons.com/images/love/couples/on-the-cheek.gif" id="an1" data-value=":love2:"></div>' +
            '<div style="margin-right:10px!important; float:left!important; width:56px!important; height:56px!important;"><img class="emoticons" style=" width:48px!important;" src="http://www.myemoticons.com/images/love/kisses/kisses.gif" id="an1" data-value=":love3:"></div>' +
			'<div style="margin-right:10px!important; float:left!important; width:56px!important; height:56px!important;"><img class="emoticons" style=" width:48px!important;" src="http://www.myemoticons.com/images/love/kisses/valentine-butterfly-kiss.gif" id="an1" data-value=":love4:"></div>' + 
			'<div style="margin-right:10px!important; float:left!important; width:56px!important; height:56px!important;"><img class="emoticons" style=" width:48px!important;" src="http://www.myemoticons.com/images/love/kisses/blow-kiss.gif" id="an1" data-value=":love5:"></div>' +
			'<div style="margin-right:10px!important; float:left!important; width:56px!important; height:56px!important;"><img class="emoticons" style=" width:48px!important;" src="http://www.myemoticons.com/images/love/hearts-2/dating.gif" id="an1" data-value=":love6:"></div>' +
			'<div style="margin-right:10px!important; float:left!important; width:56px!important; height:56px!important;"><img class="emoticons" style=" width:48px!important;" src="http://www.myemoticons.com/images/love/hearts-2/i-love-you.gif" id="an1" data-value=":love7:"></div>' +			
			'<div style="margin-right:10px!important; float:left!important; width:56px!important; height:56px!important;"><img class="emoticons" style="width:48px!important;" src="http://www.myemoticons.com/images/love/hearts-2/cupid.gif" id="an1" data-value=":love8:"></div>' +
			'<div style="margin-right:10px!important; float:left!important; width:56px!important; height:56px!important;"><img class="emoticons" style=" width:48px!important;" src="http://www.myemoticons.com/images/love/hearts-3/i-love-you.gif" id="an1" data-value=":love9:"></div>' +			
			'<div style="margin-right:10px!important; float:left!important; width:56px!important; height:56px!important;"><img class="emoticons" style=" width:48px!important;" src="http://www.myemoticons.com/images/love/hearts-3/call-me.gif" id="an1" data-value=":love10:"></div>' +
			'<div style="margin-right:10px!important; float:left!important; width:56px!important; height:56px!important;"><img class="emoticons" style="width:48px!important;" src="http://www.myemoticons.com/images/love/hearts-3/burning-heart.gif" id="an1" data-value=":love11:"></div>' +
			'<div style="margin-right:10px!important; float:left!important; width:56px!important; height:56px!important;"><img class="emoticons" style="width:48px!important;" src="http://www.myemoticons.com/images/love/other/hi-there-sweetheart.gif" id="an1" data-value=":love12:"></div>' +
			'<div style="margin-right:10px!important; float:left!important; width:56px!important; height:56px!important;"><img class="emoticons" style="width:48px!important;" src="http://www.myemoticons.com/images/love/other/love-sick.gif" id="an1" data-value=":love13:"></div>' +
			'<div style="margin-right:10px!important; float:left!important; width:56px!important; height:56px!important;"><img class="emoticons" style="width:48px!important;" src="http://www.myemoticons.com/images/love/hearts-1/blings.gif" id="an1" data-value=":love14:"></div>' +
			'<div style="margin-right:10px!important; float:left!important; width:56px!important; height:56px!important;"><img class="emoticons" style="width:48px!important;" src="http://www.myemoticons.com/images/love/hearts-1/yowza.gif" id="an1" data-value=":love15:"></div>' +
			'<div style="margin-right:10px!important; float:left!important; width:56px!important; height:56px!important;"><img class="emoticons" style=" width:48px!important;" src="http://www.myemoticons.com/images/love/hearts-1/valentine-heart-bottle.gif" id="an1" data-value=":love16:"></div><div class="clearfix"></div>'
			);
		$('#generalModal').modal('show');
		$(".emoticons").on('click', function()
		{
	...
	$('body').on('click', '#sports', function() {
		...
		$('.modal-body').html(
			'<div class="clearfix"></div><div style="margin-right:10px!important; float:left!important; width:56px!important; height:56px!important;"><img class="emoticons" style=" width:48px!important;" src="http://www.myemoticons.com/images/sports/basketball/basketball.gif" id="an1" data-value=":sport1:"></div>' +
            '<div style="margin-right:10px!important; float:left!important; width:56px!important; height:56px!important;"><img class="emoticons" style=" width:48px!important;" src="http://www.myemoticons.com/images/sports/basketball/basketball-1.gif" id="an1" data-value=":sport2:"></div>' +
            '<div style="margin-right:10px!important; float:left!important; width:56px!important; height:56px!important;"><img class="emoticons" style=" width:48px!important;" src="http://www.myemoticons.com/images/sports/olympics/soccer.gif" id="an1" data-value=":sport3:"></div>' +
            '<div style="margin-right:10px!important; float:left!important; width:56px!important; height:56px!important;"><img class="emoticons" style=" width:48px!important;" src="http://www.myemoticons.com/images/sports/olympics/torch.gif" id="an1" data-value=":sport4:"></div>' +
            '<div style="margin-right:10px!important; float:left!important; width:56px!important; height:56px!important;"><img class="emoticons" style=" width:48px!important;" src="http://www.myemoticons.com/images/sports/olympics/slugger-1.gif" id="an1" data-value=":sport5:"></div>' +				
            '<div style="margin-right:10px!important; float:left!important; width:56px!important; height:56px!important;"><img class="emoticons" style=" width:48px!important;" src="http://www.myemoticons.com/images/sports/tennis/tennis.gif" id="an1" data-value=":sport6:"></div>' +	
            '<div style="margin-right:10px!important; float:left!important; width:56px!important; height:56px!important;"><img class="emoticons" style=" width:48px!important;" src="http://www.myemoticons.com/images/sports/water/scuba-diver.gif" id="an1" data-value=":sport7:"></div>' +				
			'<div style="margin-right:10px!important; float:left!important; width:56px!important; height:56px!important;"><img class="emoticons" style=" width:48px!important;" src="http://www.myemoticons.com/images/sports/golf/golfer.gif" id="an1" data-value=":sport8:"></div><div class="clearfix"></div>'
			);
		$('#generalModal').modal('show');
		$(".emoticons").on('click', function()
		{
