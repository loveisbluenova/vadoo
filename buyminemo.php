...
include 'PHP/loginuser.php';
	...
	$buzzypaidservice_price=$row['buzzypaidservice_price'];	
	 ...
	 if($session_buzzyuser_credits>=$buzzypaidservice_price){	  
        $add_minemo_query = "INSERT INTO buzzyservicepayouts(buzzypaidservice_id,buzzyuser_id,buzzyservicepayout_timestamp)
		 	  VALUES(2,:buzzyuser_id,:buzzyservicepayout_timestamp)";
        // prepare the statement
        $stmt = $connwrite->prepare($add_minemo_query);
