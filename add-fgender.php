...
$OK = false;
        $update_userbd_query = "UPDATE buzzyusers SET buzzyuser_genre=1 WHERE buzzyuser_id=$session_user_id";
        $stmt = $connwrite->prepare($update_userbd_query);
        // bind the parameters and execute the statement
        // execute and get number of affected rows
        $stmt->execute();		
        $OK = $stmt->rowCount();	
	    header('Location: '.$link_prefix.'missing-data.php?add-so=true');			