...
<div id="type" class="collapse border-top">
	<div id="chat-toolbar">
        ...
        <a id="love" href="#"><i class="fa fa-heart" aria-hidden="true"></i></a>	
        <a id="sports" href="#"><i class="fa fa-futbol-o" aria-hidden="true"></i>	</a>	
   ...
   if($session_buzzyuser_image!=''){
		...
		$final_session_buzzyuser_image=$img_prefix . $session_buzzyuser_image; 
            ...
            <a href="../user.php?user-id=<?php echo $message['user_id']; ?>" class="pull-left">
                <img src="<?php echo $final_session_buzzyuser_image;?>" class="media-object" width="48" height="48">
            </a>
