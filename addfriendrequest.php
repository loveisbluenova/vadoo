...
$now=time();
	...
	$buzzyfriend=$_POST['buzzyfriend'];	  
   $add_friend_query = "INSERT INTO buzzyfriends(buzzyuser_id,buzzyfriend,buzzyfriend_timestamp)
		 	  VALUES(:buzzyuser_id,:buzzyfriend,:buzzyfriend_timestamp)";
        // prepare the statement
        $stmt = $connwrite->prepare($add_friend_query);
        // bind the parameters and execute the statement
        $stmt->bindParam(':buzzyuser_id', $session_user_id, PDO::PARAM_STR);
		$stmt->bindParam(':buzzyfriend', $buzzyfriend, PDO::PARAM_STR);
		$stmt->bindParam(':buzzyfriend_timestamp', $now, PDO::PARAM_STR);		
